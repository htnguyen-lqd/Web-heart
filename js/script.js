...
const palette = [
  ...
  new THREE.Color("#d60474"),
  new THREE.Color("#9714e3"),
  new THREE.Color("#e31414"),
  new THREE.Color("#5a02de"),
  new THREE.Color("#de2702"),
];
class SparkPoint {
  constructor() {
    sampler.sample(pos);
  ...
  update(a) {
    const noise =
      ...
      1.5;
    const noise2 =
      simplex.noise4D(this.pos.x * 600, this.pos.y * 600, this.pos.z * 600, 1) +
      1;
    this.one = this.pos.clone().multiplyScalar(1.01 + noise * 0.15 * beat.a);
    this.two = this.pos
      .clone()
      .multiplyScalar(1 + noise2 * 1 * (beat.a + 0.55) - beat.a * 1.5);
  }
}
